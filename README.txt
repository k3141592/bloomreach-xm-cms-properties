...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/brxmproperties>.
...
as org.example/brxmproperties:0.1.0-SNAPSHOT
